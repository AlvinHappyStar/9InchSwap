    ...
    <>
      {rewardCakePerSecond ? (
        <>
          <Text>
            {t(
              "The Multiplier represents the proportion of BBC rewards each farm receives, as a proportion of the BBC produced each second."
            )}
          </Text>
          <Text my="24px">
            {" "}
            {t("For example, if a 1x farm received 1 BBC per second, a 40x farm would receive 40 BBC per second.")}
          </Text>
        ...
        <>
          ...
          <Text>
            {t(
              "We have recently rebased multipliers by a factor of 10, this is only a visual change and does not affect the amount of BBC each farm receives."
            )}
          </Text>
          <Link
            mt="8px"
                ...
                <li>
                  <Text fontSize="12px" textAlign="center" color="textSubtle" display="inline">
                    {t("LP rewards: %percent%% trading fees, distributed proportionally among LP token holders.", {
                      percent: stableSwapAddress && stableLpFee ? BIG_ONE_HUNDRED.times(stableLpFee).toNumber() : 0.22,
                    })}
                  </Text>
                </li>
                <li>
