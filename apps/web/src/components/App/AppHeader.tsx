...
import { Flex, Heading, IconButton, ArrowBackIcon, QuestionHelper } from '@pancakeswap/uikit'
...
const AppHeader: React.FC<React.PropsWithChildren<Props>> = ({ title, helper, backTo }) => {
