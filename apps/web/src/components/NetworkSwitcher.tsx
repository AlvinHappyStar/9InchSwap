...
import { ChainDefaultId, ChainId, NATIVE } from '@pancakeswap/sdk'
import {
  ArrowDownIcon,
  ArrowUpIcon,
  Box,
...
const WrongNetworkSelect = ({ switchNetwork, chainId }) => {
  ...
  const localChainId = useLocalNetworkChain() || ChainDefaultId
  ...
  return (
    <Box ref={cannotChangeNetwork ? targetRef : null} height="100%">
      ...
      <UserMenu
        ...
        avatarSrc={`/images/chains/${ChainId[chainId].toLowerCase()}.png`}
