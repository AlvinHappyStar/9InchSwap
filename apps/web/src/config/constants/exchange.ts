import { ChainDefaultId, ChainId, JSBI, NATIVE, Percent, Token, WNATIVE } from '@pancakeswap/sdk'
import { BigNumber } from '@ethersproject/bignumber'
import { bscTokens, bscTestnetTokens, ethereumTokens, USDC, USDT, BUSD, WBTC_ETH, CAKE, goerliTestnetTokens } from '@pancakeswap/tokens'
import { ChainMap, ChainTokenList } from './types'

export const ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '0xEfF92A263d31888d860bD50809A8D171709b7b1c',
  [ChainId.GOERLI]: '0xF94B05c180B62ff280f4Fc3f95efFAf80dbB93E8',
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.GOERLI]: [goerliTestnetTokens.cake, goerliTestnetTokens.pp, goerliTestnetTokens.dbi, goerliTestnetTokens.pld],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.ETHEREUM]: [
    ...
    [WNATIVE[ChainId.ETHEREUM], ethereumTokens.sfy],
  ],
  [ChainId.BSC]: [
...
// BNB
export const DEFAULT_INPUT_CURRENCY = NATIVE[ChainDefaultId].symbol
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = CAKE[ChainDefaultId].address

// Handler string is passed to Gelato to use PCS router
export const GELATO_HANDLER = 'uniswap'
