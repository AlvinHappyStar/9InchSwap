...
export default function AddLiquidity({ currencyA, currencyB }) {
  ...
  const zapTokenCheckedA = currencyBalances?.[Field.CURRENCY_A]?.greaterThan(0)
  const zapTokenCheckedB = currencyBalances?.[Field.CURRENCY_B]?.greaterThan(0)
    ...
    <Page>
      ...
      {!showAddLiquidity && (
        <div style={{
          ...
          background: 'linear-gradient(90deg, #29011f 0%, #27011f 50%, #24011f 100%)',
          zIndex: '1',
        }}>
          <ChoosePair
            error={error}
...
}
{
  !(addIsUnsupported || addIsWarning) ? (
    pair && !noLiquidity && pairState !== PairState.INVALID ? (
      <AutoColumn style={{ minWidth: '20rem', width: '100%', maxWidth: '400px', marginTop: '1rem', zIndex: '1'}}>
