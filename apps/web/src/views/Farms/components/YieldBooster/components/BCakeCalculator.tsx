...
const BCakeCalculator: React.FC<React.PropsWithChildren<BCakeCalculatorProps>> = ({
  ...
  const conversionUnit = editingCurrency === EditingCurrency.TOKEN ? 'USD' :  '9INCH' 
  ...
  } = useTooltip(t('Boost multiplier calculation does not include profit from 9INCH staking pool'), {
    placement: 'top-end',
    tooltipOffset: [20, 10],
  })
