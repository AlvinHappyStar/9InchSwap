...
const Farms: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  return (
    <FarmsContext.Provider value={providerValue}>
      ...
      {/* </PageHeader> */}
      <Page>
        <FarmH1 as="h1" scale="xxl" color="secondary" mb="24px" ml="30px">
          {t('Farms')}
        </FarmH1>
        ...
        <div style={{
          ...
          background: viewMode === ViewMode.TABLE ? 'linear-gradient(90deg, #29011f 0%, #27011f 50%, #24011f 100%)' : 'transparent',

          border: viewMode === ViewMode.TABLE ? '1px solid rgb(93, 92, 93)' : 'none',
          boxShadow: viewMode === ViewMode.TABLE ? 'rgb(255, 255, 255) 0px 2px 8px' : 'none',
          display: 'flex',
          flexDirection: 'column'
        }}>
          <ControlContainer>
            <ViewControls>
              <Flex mt="20px" flexWrap="wrap" alignItems="center">
                <ToggleView idPrefix="clickFarm" viewMode={viewMode} onToggle={setViewMode} />
                <Text color="text" fontSize="12px" ml="3px">
