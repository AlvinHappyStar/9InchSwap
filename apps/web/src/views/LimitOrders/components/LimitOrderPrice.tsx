...
import { Input, Flex, Text, SyncAltIcon } from '@pancakeswap/uikit'
    ...
    <>
      ...
      <Flex justifyContent="space-between" id={id}>
        <div style={{
          ...
          {hasCurrencyInfo && (
            <LabelContainer justifyContent="flex-end" alignItems="center" onClick={toggleRateType} mr="10px" pl="25px">
              <Text small bold>
                {label}
              </Text>
