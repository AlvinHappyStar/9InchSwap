        ...
        <Box>
          <Text>
            {isBoostingExpired
              ...
              : t(
                  'Voting power is calculated using the staking amount and remaining staking duration of the fixed-term 9INCH staking position at the block.',
                )}
          </Text>
          <Text bold m="10px 0">
            {`${t('9INCH locked:')} ${formatNumber(lockedCakeBalance, 0, 2)}`}
          </Text>
                ...
                <Flex mt="10px" flexDirection="column" alignItems="flex-end">
                  ...
                  <Flex>
                    ...
                    <Text ml="4px" color={isBoostingExpired ? 'warning' : 'secondary'} fontSize="12px">
                      {isBoostingExpired ? t('Boosting Expired') : t('Boosted by 9INCH')}
                    </Text>
                  </Flex>
                </Flex>
              </FixedTermCardInner>
