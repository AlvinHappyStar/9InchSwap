  ...
  return (
    <>
      <Box>
        ...
        <LightGreyCard>
          <BalanceRow title={t('9INCH to be locked')} value={lockedAmount} newValue={newLockedAmount} decimals={2} />
      ...
      {showLockWarning && (
        <Box mt="16px" maxWidth="370px">
          <Message variant="warning">
            <MessageText>
              {t('You will be able to withdraw the staked 9INCH and profit only when the staking position is unlocked')}
            </MessageText>
          </Message>
        </Box>
      )}
